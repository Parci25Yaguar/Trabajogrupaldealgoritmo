...
Funcion opc = presentarMenu(titulo,opciones,lim) 
	...
	Fin Para
	Escribir "ELIJA UNA OPCION [1...",lim,"]: "
	Leer opc
FinFuncion
...
funcion SumarORestar()
	...
	Repetir
		...
		Si no(vopc='R' o vopc='S' o vopc='s' o vopc='r') Entonces
			escribir "Ha ingresado mal la opción, intente nuevamente"
			esperar 2 segundos
		Fin Si
...
funcion comprarproducto
	...
	Escribir "Ingrese la venta: " Sin Saltar
	Leer venta
	iva = venta * 0.12
...
funcion NotaAlumno
	...
	Si promedio > 70 Entonces
		Escribir "Haz aprobado el módulo"
	SiNo
		Escribir "Haz reprobado el módulo"
	Fin Si
...
Funcion SECUENCIA_MAYOR_Y_MENOR()
	...
	Escribir ""
	Escribir "El número mayor de todos fue: ", vmayor
	Escribir "El número menor de todos fue: ", vmenor
FinFuncion
...
funcion primos_gemelos()
	...
	escribir "Digite el primer número: " Sin Saltar
	leer num1
	cont = 1
	contdiv = 0
	Repetir
	...
	escribir ""
	si contdiv = 2 Entonces
		escribir "Digite el segundo número: " Sin Saltar
		leer num2
	...
	Mientras opcion <> "4" Hacer
		...
		Segun opcion Hacer
			...
			"3":
				...
				Fin Mientras
			"4":
				Escribir "GRACIAS POR USAR NUESTRO SISTEMA ;), VUELVE PRONTO"	
			De Otro Modo:
				Escribir "Opcion incorrecta"
		Fin Segun
    Fin Mientras
